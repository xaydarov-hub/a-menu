  ...
  export default function Login() {
    ...
    // Bu effect faqat MOUNT da bir marta ishlaydi
      useEffect(() => {
    ...
    useEffect(() => {
      ...
      const checkDb = async () => {
        try {
          // super_admin yo'lini ping sifatida ishlatamiz (har doim mavjud yoki null)
    ...
    // ── 4. Oxirgi kirish vaqtini yangilaш ────────────────────────────────────
    ...
    const handleLogin = async () => {
      ...
      try {
        // ── A. Super Admin (Firebase dan o'qiladi) ──────────────────────────
        ...
        if (adminsData) {
          // Object.entries orqali [id, data] ni birgalikda olamiz
          ...
          // Bloklangan admin (parol to'g'ri lekin blocked)
          ...
          <div style={S.hints}>
            <div style={S.hintItem}>
              ...
              <span style={{ color:"#7fa86b", fontSize:12 }}>
                <b style={{ color:"#9b59b6" }}>Super Admin</b> — Firebase da yaratiladi (birinchi ishga tushirishda)
              </span>
            </div>
            <div style={S.hintItem}>
  ...
  const S = {
    ...
    hints:     { marginTop:"24px", padding:"14px 16px", background:"rgba(255,255,255,0.03)", border:"1px solid rgba(134,176,84,0.15)", borderRadius:"10px", display:"flex", flexDirection:"column", gap:"8px" },
    hintItem:  { display:"flex", alignItems:"center", gap:"10px", fontSize:"12px" },
    hintDot:   { width:"7px", height:"7px", borderRadius:"50%", flexShrink:0 },
    footerNote:{ textAlign:"center", color:"#3d5c38", fontSize:"11px", marginTop:"16px", letterSpacing:"0.5px" },
  };